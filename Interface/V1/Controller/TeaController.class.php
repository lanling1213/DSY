 ...
 */
    public function answerList()
    {
        ...
        $answerList = M('answer')->alias('a')
            ...
            ->field('IFNULL(s1.stu_head_img,t.tea_head_img) as ans_head,IFNULL(s1.stu_nickname,t.tea_name) as ans_name,a.a_content,a.a_time,IF('.$this->userTeaID.'=a.a_tea_id,"1","0") as isMyAnswer')
